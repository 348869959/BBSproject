var oPopup;      
  ...
  function popmsg(msgnum,msgstr){      
   ...
   winstr   +='   <td style="font-weight: normal; font-size: 12px; background-image: url(msgTopBg.gif); color: #1f336b; padding-top: 4px;padding-left: 4px" valign=center width="100%"> Manage platform message prompts：</td>';      
   ...
   winstr   +='                    You have <font color=#FF0000>'+msgnum+'</font>new message<br><br>';      
